...
<head>
		...
		<meta name='description' content='<?=$this->config->item('desc')?>' />
		<meta name='keywords' content='<?=$this->config->item('keywords')?>' />
...
<div id="mnfooter">&copy; 2013 Ayus Fashion, Korset Pembentukan Badan Murah untuk Kurus Cepat.</div>
<noscript>
