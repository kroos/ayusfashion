		...
		public function Header()
			{
				$CI =& get_instance();
				// Logo
				//$image_file = K_PATH_IMAGES.'hubungi_01.jpg';
				$image_file = base_url().'images/'.$CI->config->item('logo');
				...
				// Title
				//$this->SetY(15);
				$this->Cell(0, 15, $CI->config->item('stitle'), '', 2, 'C', FALSE, '', 0, false, 'M', 'C');
				$this->SetFont('helvetica', '', 10);
				$this->Cell(0, 15, $CI->config->item('reg_company'), '', 2, 'C', FALSE, '', 0, false, 'M', 'C');
				//$this->GetY();
			}
