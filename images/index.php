...
<head>
  ...
  <title>Action Announcer - Make money when people try to abandon
your website </title>


<?php require_once('class.JavaScriptPacker.php');
if(empty($_REQUEST['overlayurl'])) $_REQUEST['overlayurl'] = "http://www.actionannouncer.com/images/overlay.gif";
if(empty($_REQUEST['width'])) $_REQUEST['width'] = 450;
if(empty($_REQUEST['height'])) $_REQUEST['height'] = 300;
if(empty($_REQUEST['bordercolor'])) $_REQUEST['bordercolor'] = '#e4e4e4';
if(empty($_REQUEST['bgtitle'])) $_REQUEST['bgtitle'] = '#0099ff';
if(empty($_REQUEST['url'])) $_REQUEST['url'] = 'http://www.ezine-zap.com/';
...
<table style="border-collapse: collapse;" bgcolor="#ffffff" border="1" bordercolor="#c0c0c0" cellpadding="0" cellspacing="0" width="680">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td> <img src="http://www.actionannouncer.com/images/header.jpg" border="0" height="120" width="680">
      <div align="center">
      <center>
      <table style="border-collapse: collapse; width: 646px; height: 0px;" border="0" bordercolor="#111111" cellpadding="0" cellspacing="0">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td width="100%"> If you need help with color
hex codes, <a target="_blank" href="http://www.asahi-net.or.jp/%7EFX6M-FJMY/java09e.html">click
here.</a><br>

            <p class="body"><span lang="en-gb"><font style="font-size: 11pt;" face="Verdana">
            <form action="" method="get">Width: <input name="width" size="5" value="<?php echo $_REQUEST['width'];?>" type="text">
              <br>

              <br>

Height: <input name="height" size="5" value="<?php echo $_REQUEST['height'];?>" type="text"><br>

              <br>

Border color: <input size="10" name="bordercolor" value="<?php echo $_REQUEST['bordercolor'];?>" type="text"><br>

              <br>

Title background color: <input size="10" name="bgtitle" value="<?php echo $_REQUEST['bgtitle'];?>" type="text"><br>

              <br>

URL of the popup contents: <input size="48" name="url" value="<?php echo $_REQUEST['url'];?>" type="text"><br>

              <br>

overlay.gif image address: <input size="48" name="overlayurl" value="<?php echo $_REQUEST['overlayurl'];?>" type="text"><br>
...
Paste this output above your webpages &lt;/head&gt; tag:<br>
